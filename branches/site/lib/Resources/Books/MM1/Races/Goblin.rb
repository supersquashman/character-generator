	...
	def apply_level
		...
		if(character.level <= 1)
			if (character.sex == "Male") #male
				...
				character.weight = (character.height.to_i * 0.91) #extra weight is determined by multiplying the weight multiplier by the extra height
			end
