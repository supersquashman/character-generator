...
#++
	def initialize(character)
		...
		character.final_levelup_procs += [%{Proc.new { |character|character.HP = Roll.new(character.HD.to_s + "d12 + #{(character.HD * character.stat_mod["con"])}")}}]
