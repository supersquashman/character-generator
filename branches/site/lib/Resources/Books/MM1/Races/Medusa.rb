# Medusa - Model of D&D race and container for related information
...
#++
	def initialize(character)
		...
		@favored_classes = ClassList.list #All classes
...
#++
	def apply_level
		...
		if character.level <= 1
			...
			character.add_ability("Petrifying Gaze(30ft.)")
			character.add_ability("Poison")
		end
	end
end
#RaceList.push(Medusa,"MM1")