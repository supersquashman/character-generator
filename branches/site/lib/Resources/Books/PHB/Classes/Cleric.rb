...
require "#{File.dirname(__FILE__)}/../Magic/Spells/ClericSpells"
require "#{File.dirname(__FILE__)}/../Magic/Spells/ClericDomains"
...
#++
    ...
    character.spells.domains_known.each {|domain| eval(SpellList.granted_powers_procs[domain]).call(character, self)}
		super
