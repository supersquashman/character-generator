# WizardSpells - List of D&D Spells[SpellModel] for Wizard
...
SpellList.load_spells("0", "Wizard", [
...
SpellList.load_spells("1", "Wizard", [
...
SpellList.load_spells("2", "Wizard", [
...
SpellList.load_spells("3", "Wizard", [
...
SpellList.load_spells("4", "Wizard", [
...
["Rary's Mnemonic Enhancer", "", "PH p268", "Prepares extra spells or retains one just cast. Wizards only"],
["Reduce Person, Mass(PH p269", "Reduces several creatures."],
["Stone Shape", "", "PH p284", "", "Sculpts stone into any shape."]])

SpellList.load_spells("5", "Wizard", [
...
SpellList.load_spells("6", "Wizard", [
...
["Mordenkainen's Lucubration", "", "PH p256", "Recalls spell of 5th level or lower. Wizards only."],
...
SpellList.load_spells("7", "Wizard", [
...
SpellList.load_spells("8", "Wizard", [
...
SpellList.load_spells("9", "Wizard", [
