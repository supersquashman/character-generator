...
#++
	def apply_level
		...
		if(character.level <= 1)
			...
			character.add_ability("Weapon Proficiency (Longsword)")
			character.add_ability("Weapon Proficiency (Rapier)")
			character.add_ability("Weapon Proficiency (Longbow)")
			character.add_ability("Weapon Proficiency (Shortbow)")
