...
SpellList.load_spells("1", "Cleric", [
...
["Deathwatch", "", "PH p217", "Reveals how near death subjects within 30' area."],
...
SpellList.load_spells("2", "Cleric", [
...
SpellList.load_spells("3", "Cleric", [
...
SpellList.load_spells("4", "Cleric", [
...
SpellList.load_spells("5", "Cleric", [
["Atonement", "", "PH p201", "Removes burden of misdeeds from subject."],
["Break Enchantment", "", "PH p207", "Frees subjects from enchantments, alterations, curses, and petrification."],
["Command, Greater", "", "PH p211", "As command, but affects one subject/level."],
["Commune", "", "PH p211", "Deity answers one yes-or-no question/level."],
["Cure Light Wounds, Mass", "", "PH p216", "Cures 1d8 damage +1/level for many creatures."],
["Dispel Chaos/Evil/Good/Law", "", "PH p222", "+4 bonus against attacks."],
["Disrupting Weapon", "", "PH p225", "Melee weapon destroys undead."],
["Flame Strike", "", "PH p231", "Smite foes with divine fire (1d6/level damage)."],
["Hallow", "", "PH p238", "Designates location as holy."],
["Inflict Light Wounds, Mass", "", "PH p244", "Deals 1d8 damage +1/level to many creatures."],
["Insect Plague", "", "PH p244", "Locust swarms attack creatures."],
["Mark of Justice", "", "PH p252", "Designates action that will trigger curse on subject."],
["Plane Shift", "", "PH p262", "As many as eight subjects travel to another plane."],
["Raise Dead", "", "PH p268", "Restores life to subject who died as long as one day/level ago."],
["Righteous Might", "", "PH p273", "Your size increases, and you gain combat bonuses."],
["Scrying", "", "PH p274", "Spies on subject from a distance."],
["Slay Living", "", "PH p280", "Touch attack kills subject."],
["Spell Resistance", "", "PH p282", "Subject gains SR 12 + level."],
["Summon Monster V", "", "PH p286", "Calls extraplanar creature to fight for you."],
["Symbol of Pain", "", "PH p290", "Triggered rune wracks nearby creatures with pain."],
["Symbol of Sleep", "", "PH p291", "Triggered rune puts nearby creatures into catatonic slumber."],
["True Seeing", "", "PH p296", "Lets you see all things as they really are."],
["Unhallow", "", "PH p297", "Designates location as unholy."],
["Wall of Stone", "", "PH p299", "Creates a stone wall that can be shaped."]
])

SpellList.load_spells("6", "Cleric", [
["Animate Objects", "", "PH p199", "Objects attack your foes."],
["Antilife Shell", "", "PH p200", "10-ft. field hedges out living creatures."],
["Banishment", "", "PH p203", "Banishes 2 HD/level of extraplanar creatures."],
["Bear's Endurance, Mass", "", "PH p203", "As bear's endurance, affects one subject/ level."],
["Blade Barrier", "", "PH p205", "Wall of blades deals 1d6/level damage."],
["Bull's Strength, Mass", "", "PH p207", "As bull's strength, affects one subject/level."],
["Create Undead", "", "PH p215", "Create ghouls, ghasts, mummies, or mohrgs."],
["Cure Moderate Wounds, Mass", "", "PH p216", "Cures 2d8 damage +1/level for many creatures."],
["Dispel Magic, Greater", "", "PH p223", "As dispel magic, but up to +20 on check."],
["Eagle's Splendor, Mass", "", "PH p225", "As eagle's splendor, affects one subject/level."],
...
["Glyph of Warding, Greater", "", "PH p237", "As glyph of warding, but up to 10d8 damage or 6th-level spell."],
["Harm", "", "PH p239", "Deals 10 points/level damage to target."],
["Heal", "", "PH p239", "Cures 10 points/level of damage, all diseases and mental conditions."],
["Heroes' Feast", "", "PH p240", "Food for one creature/level cures and grants combat bonuses."],
["Inflict Moderate Wounds, Mass", "", "PH p244", "Deals 2d8 damage +1/level to many creatures."],
["Owl's Wisdom, Mass", "", "PH p259", "As owl's wisdom, affects one subject/level."],
["Planar Ally", "", "PH p261", "As lesser planar ally, but up to 12 HD."],
["Summon Monster VI", "", "PH p287", "Calls extraplanar creature to fight for you."],
...
["Undeath to Death", "", "PH p297", "Destroys 1d4 HD/level undead (max 20d4)."],
["Wind Walk", "", "PH p302", "You and your allies turn vaporous and travel fast."],
["Word of Recall", "", "PH p303", "Teleports you back to designated place."]
])

SpellList.load_spells("7", "Cleric", [
["Blasphemy", "", "PH p205", "Kills, paralyzes, weakens, or dazes nonevil subjects."],
["Control Weather", "", "PH p214", "Changes weather in local area."],
["Cure Serious Wounds, Mass", "", "PH p216", "Cures 3d8 damage +1/level for many creatures."],
["Destruction", "", "PH p218", "Kills subject and destroys remains."],
["Dictum", "", "PH p220", "Kills, paralyzes, slows, or deafens nonlawful subjects."],
["Ethereal Jaunt", "", "PH p227", "You become ethereal for 1 round/level."],
["Holy Word", "", "PH p242", "Kills, paralyzes, blinds, or deafens nongood subjects."],
["Inflict Serious Wounds, Mass", "", "PH p244", "Deals 3d8 damage +1/level to many creatures."],
["Refuge", "", "PH p269", "Alters item to transport its possessor to you."],
["Regenerate", "", "PH p270", "Subject's severed limbs grow back, cures 4d8 damage +1/level (max +35)."],
...
["Resurrection", "", "PH p272", "Fully restore dead subject."],
["Scrying, Greater", "", "PH p275", "As scrying, but faster and longer."],
["Summon Monster VII", "", "PH p287", "Calls extraplanar creature to fight for you."],
...
["Word of Chaos", "", "PH p303", "Kills, confuses, stuns, or deafens nonchaotic subjects."]
])

SpellList.load_spells("8", "Cleric", [
["Antimagic Field", "", "PH p200", "Negates magic within 10 ft."],
["Cloak of Chaos", "", "PH p210", "+4 to AC, +4 resistance, and SR 25 against lawful spells."],
["Create Greater Undead", "", "PH p215", "Create shadows, wraiths, spectres, or devourers."],
["Cure Critical Wounds, Mass", "", "PH p215", "Cures 4d8 damage +1/level for many creatures."],
["Dimensional Lock", "", "PH p221", "Teleportation and interplanar travel blocked for one day/level."],
["Discern Location", "", "PH p22", "2Reveals exact location of creature or object."],
["Earthquake", "", "PH p225", "Intense tremor shakes 80-ft.-radius."],
["Fire Storm", "", "PH p231", "Deals 1d6/level fire damage."],
["Holy Aura", "", "PH p241", "+4 to AC, +4 resistance, and SR 25 against evil spells."],
["Inflict Critical Wounds, Mass", "", "PH p244", "Deals 4d8 damage +1/level to many creatures."],
["Planar Ally, Greater", "", "PH p261", "As lesser planar ally, but up to 18 HD."],
["Shield of Law", "", "PH p278", "+4 to AC, +4 resistance, and SR 25 against chaotic spells."],
["Spell Immunity, Greater", "", "PH p282", "As spell immunity, but up to 8th-level spells."],
["Summon Monster VIII", "", "PH p287", "Calls extraplanar creature to fight for you."],
...
["Unholy Aura", "", "PH p297", "+4 to AC, +4 resistance, and SR 25 against good spells."]
])

SpellList.load_spells("9", "Cleric", [
["Astral Projection", "", "PH p201","Projects you and companions onto Astral Plane."],
...
["Implosion", "", "PH p243", "Kills one creature/round."],
["Miracle", "", "PH p254", "Requests a deity's intercession."],
["Soul Bind", "", "PH p281", "Traps newly dead soul to prevent resurrection."],
